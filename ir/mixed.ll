; ModuleID = '/mnt/host/d/CD LAB EL/FunctionInliningpass/tests/mixed.c'
...
define dso_local i32 @main() #0 {
  ...
  %6 = call i32 @add(i32 noundef 2, i32 noundef 3)
  store i32 %6, ptr %2, align 4
  %7 = load i32, ptr %2, align 4
  %8 = call i32 @mul3(i32 noundef %7)
  store i32 %8, ptr %3, align 4
  %9 = load i32, ptr %3, align 4
  %10 = call i32 @large_helper(i32 noundef %9)
  store i32 %10, ptr %4, align 4
  %11 = call i32 @recurse(i32 noundef 4)
